                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: Text(
                          goalDeadline == null
                              ? "Pick a Date"
                              : goalDeadline!.toLocal().toString().split(' ')[0],
                        ),
                      ),
                    ],
                  ),
                      ...
                      TextButton(
                        ...
                        child: Text(
                          subtaskDeadline == null
                              ? "Pick a Date"
                              : subtaskDeadline!.toLocal().toString().split(' ')[0],
                        ),
                      ),
                    ],
                  ),
          ...
          return AlertDialog(
                          ...
                          children: [
                            Checkbox(
                              ...
                              onChanged: (value) async {
                                dialogSetState(() {
                                  subtask['isChecked'] = value; // Update local subtask state
                                });
                                ...
                                setState(() {
                                  ...
                                  goal['isChecked'] = subtasks.every(
                                      (st) => st['isChecked']); // Update goal's finished status
                                });

                                // Sync updates to Firestore
                                final success = await FirestoreDataSource().update_goal(
                                  goal['id'],
                                  subtasks,
                                  goal['isChecked'],
                                  goal['score'],
                                ...
                                if (!success) {
                                  dialogSetState(() {
                                    subtask['isChecked'] =
                                        value == true ? false : true; // Rollback on failure
                                  });
            ...
            actions: [
              ...
              TextButton(
                onPressed: () {
                  Navigator.of(context).pop();
                  editGoal(context, index, goals, setState); // Navigate to edit
                },
            ...
            content: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    controller: goalTitleController,
                    decoration: const InputDecoration(hintText: "Edit goal title"),
                  ),
                  const SizedBox(height: 10),
                  ...
                  TextButton(
                    onPressed: () {
                      ...
                      } else if (subtaskGoalDeadline!.isBefore(subtaskDeadline)) {
                        dialogSetState(() {
                          errorMessage =
                ...
                onPressed: () async {
                  ...
                  if (title.isEmpty || goalDeadline == null) {
                    ...
                    if (success) {
                      ...
                      dialogSetState(() {
                        errorMessage = "Failed to update the goal. Please try again.";
                      });
                    }
                  }
                },
